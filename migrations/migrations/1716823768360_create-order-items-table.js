...
exports.up = (pgm) => {
    pgm.createTable('order_items', {
        ...
        order_id: { type: 'integer', notNull: false, references: 'orders', onDelete: 'SET NULL' },
        user_id: { type: 'integer', notNull: false, references: 'users', onDelete: 'SET NULL' },
        product_id: { type: 'integer', notNull: false, references: 'products', onDelete: 'SET NULL' },
        inventory_item_id: { type: 'integer', notNull: false, references: 'inventory_items', onDelete: 'SET NULL' },
